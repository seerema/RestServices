...
import com.seerema.shared.jpa.base.service.impl.AbstractFieldServiceImpl;

/**
 * Catalog Field Service
 */

@Service("field_" + CatalogConstants.MODULE_NAME)
public class CatalogFieldServiceImpl extends AbstractFieldServiceImpl {
